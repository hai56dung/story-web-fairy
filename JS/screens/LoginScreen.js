...
export default class LoginScreen extends BaseComponent {
  ...
  render() {
    ...
    let _email = new InputWrapper({
      id: "email-in",
      label: "Email",
      placeholder: "nhâập vào teente eura bạn",
      type: "email",
    ...
    $img.src =
      "https://firebasestorage.googleapis.com/v0/b/fairytalesci65.appspot.com/o/icons%2Fimg-bedroom.png?alt=media&token=ecc74902-2d8d-42dd-b791-b23f279f3c96";
